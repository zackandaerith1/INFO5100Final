...
public class ModifyDeliveryManJPanel extends javax.swing.JPanel {
    ...
    public ModifyDeliveryManJPanel(JPanel userProcessContainer, EcoSystem ecosystem, DeliveryManDirectory deliveryManDirectory, DeliveryMan deliveryMan) {
        ...
        firstnameTxt.setText(deliveryMan.getFirstname());
        lastnameTxt.setText(deliveryMan.getLastname());
        usernameTxt.setText(ecosystem.getUserAccountDirectory().getUserAccountList().get(3).getUsername());
        passwordTxt.setText(ecosystem.getUserAccountDirectory().getUserAccountList().get(3).getPassword());
        emailaddressTxt.setText(deliveryMan.getEmail());
        homeaddressTxt.setText(deliveryMan.getAddress());
        phonenumberTxt.setText(deliveryMan.getPhoneNumber());
    ...
    private void initComponents() {
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel2, jLabel3, jLabel4, jLabel6, jLabel7, jLabel8, jLabel9});
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel2, jLabel3, jLabel4, jLabel6, jLabel7, jLabel8, jLabel9});
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        deliveryMan.setFirstname(firstnameTxt.getText());
        deliveryMan.setLastname(lastnameTxt.getText());
        deliveryMan.setName(firstnameTxt.getText() + lastnameTxt.getText());

        ecosystem.getUserAccountDirectory().getUserAccountList().get(3).setPassword(passwordTxt.getText());
        ecosystem.getUserAccountDirectory().getUserAccountList().get(3).setUsername(usernameTxt.getText());
        deliveryMan.setEmail(emailaddressTxt.getText());
        deliveryMan.setPhoneNumber(phonenumberTxt.getText());
        deliveryMan.setAddress(homeaddressTxt.getText());

        JOptionPane.showMessageDialog(null, "Delivery Man Profile Updated Succesfully");
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        Component[] componentArray = userProcessContainer.getComponents();
        Component component = componentArray[componentArray.length - 1];
        ManageDeliveryManJPanel managecust = (ManageDeliveryManJPanel) component;
