...
public class CreateDeliveryManJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel2, jLabel3, jLabel4, jLabel6, jLabel7, jLabel8, jLabel9});
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel2, jLabel3, jLabel4, jLabel6, jLabel7, jLabel8, jLabel9});
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if (firstnameTxt.getText().isEmpty() || lastnameTxt.getText().isEmpty() || emailTxt.getText().isEmpty()
                || phoneTxt.getText().isEmpty() || usernameTxt.getText().isEmpty() || passwordTxt.getText().isEmpty()
        ...
        if (!phoneTxt.getText().matches("^[0-9]{10}$")) {
            JOptionPane.showMessageDialog(null, "Phone Number must be 10 digits", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }

        ecosystem.getDeliveryManDirectory().newDeliveryMan(fullname, firstnameTxt.getText(), lastnameTxt.getText(), homeaddressTxt.getText(), emailTxt.getText(), phoneTxt.getText());
        Employee employee = ecosystem.getEmployeeDirectory().createEmployee(emailTxt.getText());
        ecosystem.getUserAccountDirectory().createUserAccount(usernameTxt.getText(), passwordTxt.getText(), employee, new DeliverManRole());
